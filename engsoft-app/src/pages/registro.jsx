...
import { NotificacaoRegistro } from "../components/notificacaoRegistro";
import { CadastroAeronave } from "./cadastroAeronave";
import { RegistroConfirmacao } from "./registroConfirmacao";
...
export class Registro extends React.Component {
    ...
    render() {
        ...
        pagina = <CadastroAeronave handleSubmitPostCallback={this.handleSubmitPostCallback} updateNome={this.updateNome} />
